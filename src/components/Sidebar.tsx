          ...
          <div className="absolute bottom-2 left-2 right-2">
            ...
            {currentUser && (
              <div className="mb-2">
                ...
                >
                  <div className="p-2 rounded-xl cursor-pointer transition-all duration-200 border relative bg-black/20 border-white/10 hover:bg-black/30 hover:border-white/20">
                    <div className="flex items-center justify-center">
                      <img
            ...
            <div className="relative group">
              <Button
                ...
                variant="ghost"
                size="sm"
                className="w-full h-10 justify-center text-white/70 hover:text-white hover:bg-black/30 transition-all duration-300 rounded-lg opacity-100"
              >
